...
public class UsuariosServiceTest {
    ...
    public void testGetUsuario() {
        ...
        assertEquals(Listusuario, usuarios);
    }
    ...
    public void testGetTipoUSer() {
        ...
        List<Usuario> ListTipoUsuario = new ArrayList<>();
        ListTipoUsuario.add(new Usuario (1, "20.358.565-5", "Ana", "fio",  null,"ana.fio@gmail.com","Estudiante",null));
        ListTipoUsuario.add(new Usuario (2, "20.358.445-5", "Ava", "mia",  null,"ana.dao@gmail.com","Estudiante",null));

       when(usuariorepositorio.findByTipoUser("Estudiante")).thenReturn(ListTipoUsuario);
